...
public class ScoringSystem {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            int option = repeatQuestion("You Can select only integer in the menu");
            switch (option) {
                case 1:
                    ...
                    int teamNo = repeatQuestion("You Can Choose only integer");
...
//                        }
                        ...
                        for (int i = 0; i < teamNo; i++) {
                            ...
                            for (int a = 0; a < eventNo; a++) {
                                ...
                                teamRank = repeatQuestion(" You can put only rank (1,2,3) ");
                                int tRank = 0;
                    ...
                    if (teamNo == 0) {
                        ...
                        for (int i = 0; i < teamScore.length; i++) {
                            if (teamScore[i] == winner_team_score) {
                                System.out.println("\t" + teamName[i] + "has won the first prize with score:" + winner_team_score);
                            }
                        }
                        System.out.println("----------------------------------------------------------------------------");
                        System.out.println("********************");
                ...
                case 2:
                    ...
                    PartNo = repeatQuestion("You can put only number of individual participanting");
                    ...
                    if (PartNo == 0) {
                        ...
                        for (int i = 0; i < PartNo; i++) {
                            ...
                            for (int a = 0; a < 5; a++) {
                                ...
                                PartRank = repeatQuestion("You can only put rank (1,2,3)");
                                int pRank = 0;
                    ...
                    if (PartNo == 0) {
                        ...
                        for (int i = 0; i < PartScore.length; i++) {
                            if (PartScore[i] == pwinner_score) {
                                System.out.println("\t" + PartName[i] + "has won the first prize with score:" + pwinner_score);
                            }
                        }
                        System.out.println("----------------------------------------------------------------------------");
                        System.out.println("********************");
                ...
                case 3:
                    ...
                    int SpecTeamNo = repeatQuestion("Enter only number of Teams");
                    ...
                    if (SpecTeamNo == 0) {
                        ...
                        for (int i = 0; i < SpecTeamNo; i++) {
                            ...
                            for (int a = 0; a < 1; a++) {
                                ...
                                sTeamRank = repeatQuestion("You can choose only (1,2,3)");
                                int stRank = 0;
                    ...
                    if (SpecTeamNo == 0) {
                        ...
                        System.out.println("------------------         Winner          ------------------");
                        System.out.println("First Price Winner:");
                        for (int i = 0; i < SpecTeamScore.length; i++) {
                            if (SpecTeamScore[i] == Swinner_team_score) {
                                System.out.println("\t" + SpecTeamName[i] + "has won the first prize with score:" + Swinner_team_score);
                            }
                        }
                        System.out.println("----------------------------------------------------------------------------");
                        System.out.println("********************");
                ...
                case 4:
                    ...
                    SpecPartNo = repeatQuestion("You can choose only number of individuals");
                    ...
                    if (SpecPartNo == 0) {
                        ...
                        for (int i = 0; i < SpecPartNo; i++) {
                            ...
                            for (int a = 0; a < 1; a++) {
                                ...
                                int sPartRank = repeatQuestion("Enter only Rank (1,2,3)");
                                int spRank = 0;
                    ...
                    if (SpecPartNo == 0) {
                        ...
                        System.out.println("---------------------     Winner      ------------------------");
                        System.out.println("First Price Winner:");
                        for (int i = 0; i < SpecPartScore.length; i++) {
                            if (SpecPartScore[i] == spwinner_score) {
                                System.out.println("\t" + SpecPartName[i] + "has won the first prize with score:" + spwinner_score);
                            }
                        }
                        System.out.println("----------------------------------------------------------------------------");
                        System.out.println("********************");
            ...
            while(isChoice){
                if (!choice.equals("y") && !choice.equals("n")) {
                    System.out.println("Invalid Choice! Please choose only y or n");
                    choice = scan.next();
                }else{
                    isChoice = false;
                }
        ...
        System.out.println("Thanks for participating! See you again.");
        System.out.println("----------------------------------------------------------------------------\n");
        scan.close();
    }// main end


    public static int repeatQuestion(String Error) {
        int input = 0;
